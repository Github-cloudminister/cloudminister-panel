...
settingsvariables = {
    ...
    'production':{
        ...
        'dbdefault': {
            ...
            'NAME': 'ebdb_prod',
            'USER': 'surveydbuser',
            'PASSWORD': 'QjmRcR1kSfqoPHg',
            'HOST': '192.168.144.172',
            'PORT': '5432',
            'CONN_MAX_AGE': 30
        },
        'dbsecondary': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': 'ebdb_prod_backup',
            'USER': 'surveydbuser',
            'PASSWORD': 'QjmRcR1kSfqoPHg',
            'HOST': '192.168.144.172',
            'PORT': '5432',
...
DATABASES = {
    ...
    'secondary': settingsvariables[SERVER_TYPE]['dbsecondary'],
}

DATABASE_ROUTERS = ['backup.database_router.MyDatabaseRouter']
